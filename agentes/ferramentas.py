...
def abrir_site(url: str) -> dict:
    ...
    """
    import system_tools
    return system_tools.browser_open_url(url)
...
def pesquisar_na_web(consulta: str) -> dict:
    ...
    """
    import system_tools
    return system_tools.browser_search_web(consulta=consulta)
